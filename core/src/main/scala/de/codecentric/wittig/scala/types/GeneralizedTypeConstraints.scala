...
/**
  * =:= and <:< are called generalized type constraints.
  * They allow you, from within a type-parameterized class or trait, to further constrain one of its type parameters.
  *
  * @see https://stackoverflow.com/questions/3427345/what-do-and-mean-in-scala-2-8-and-where-are-they-documented
  */
