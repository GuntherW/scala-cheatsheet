...
object Library {
  ...
  final val monocle                 = "com.github.julien-truffaut"    %% "monocle-state"                    % Version.monocleVersion
