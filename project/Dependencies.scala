...
object Library {
  ...
  val calibanQuick =
    "com.github.ghostdogpr" %% "caliban-quick" % Version.caliban
  val calibanClient =
    "com.github.ghostdogpr" %% "caliban-client" % Version.caliban
  val catsCore = "org.typelevel" %% "cats-core" % Version.catsVersion
  val catsEffect = "org.typelevel" %% "cats-effect" % Version.catsEffect
  val catsEffectCps =
    "org.typelevel" %% "cats-effect-cps" % Version.catsEffectCps
  ...
  val jacksonScala =
    "tools.jackson.module" %% "jackson-module-scala" % Version.jackson
  val jacksonJsr310 =
  ...
  val jsonSchemaValidator =
    "com.networknt" % "json-schema-validator" % Version.jsonSchemaValidator
  ...
  val kafkaStreamsScala =
    "org.apache.kafka" %% "kafka-streams-scala" % Version.kafka cross CrossVersion.for3Use2_13
  ...
  val openTelemtry =
    "io.opentelemetry" % "opentelemetry-exporter-otlp" % Version.openTelemetry
  val openTelemtryAutoConfigure =
    "io.opentelemetry" % "opentelemetry-sdk-extension-autoconfigure" % Version.openTelemetry
  ...
  val pulsar4s =
    "com.clever-cloud.pulsar4s" %% "pulsar4s-core" % Version.pulsar4s
  val pulsar4sCirce =
    "com.clever-cloud.pulsar4s" %% "pulsar4s-circe" % Version.pulsar4s
  val refined = "eu.timepit" %% "refined" % Version.refined
  val resilience4j =
    "io.github.resilience4j" % "resilience4j-all" % Version.resilience4j
  val scalaParallelCollection =
    "org.scala-lang.modules" %% "scala-parallel-collections" % Version.scalaParallelCollection
  ...
  val springBootStarterWeb =
    "org.springframework.boot" % "spring-boot-starter-web" % Version.springBoot
  val springBootStarterJson =
    "org.springframework.boot" % "spring-boot-starter-json" % Version.springBoot
  ...
  val sttpJsoniter =
    "com.softwaremill.sttp.client4" %% "jsoniter" % Version.sttp
  val sttpsSlf4j =
    "com.softwaremill.sttp.client4" %% "slf4j-backend" % Version.sttp
  val sttpsOpenTelemetry =
    "com.softwaremill.sttp.client4" %% "opentelemetry-backend" % Version.sttp
  ...
  val tapirAwsLambda =
    "com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % Version.tapir
  val tapirAwsCdk =
    "com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % Version.tapir
  val tapirAwsSam =
    "com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % Version.tapir
  ...
  val tapirJdkHttp =
    "com.softwaremill.sttp.tapir" %% "tapir-jdkhttp-server" % Version.tapir
  val tapirNettyFuture =
    "com.softwaremill.sttp.tapir" %% "tapir-netty-server" % Version.tapir
  val tapirNettyServerSync =
  ...
  val zioBlocksAsync = "dev.zio" %% "zio-blocks-async" % Version.zioBlocks
  ...
  val zioBlocksMessagepack =
    "dev.zio" %% "zio-blocks-schema-messagepack" % Version.zioBlocks
  val zioBlocksThrift =
    "dev.zio" %% "zio-blocks-schema-thrift" % Version.zioBlocks
  ...
  val zioBlocksRingbuffer =
    "dev.zio" %% "zio-blocks-ringbuffer" % Version.zioBlocks
  ...
  val cucumberJunit =
    "io.cucumber" % "cucumber-junit-platform-engine" % Version.cucumber
  ...
  val junitJupiterEngine =
    "org.junit.jupiter" % "junit-jupiter-engine" % Version.junit
  val junitPlatformEngine =
    "org.junit.platform" % "junit-platform-engine" % Version.junit
  val junitPlatformLauncher =
    "org.junit.platform" % "junit-platform-launcher" % Version.junit
  val junitPlatformSuite =
    "org.junit.platform" % "junit-platform-suite" % Version.junit
  val jupiterInterface =
    "com.github.sbt.junit" % "jupiter-interface" % Version.junitJupiterInterface
  val gatlingCharts =
    "io.gatling.highcharts" % "gatling-charts-highcharts" % Version.gatling
  ...
  val testContainer =
    "com.dimafeng" %% "testcontainers-scala-scalatest" % Version.testContainer
  val testContainerMongo =
    "com.dimafeng" %% "testcontainers-scala-mongodb" % Version.testContainer
