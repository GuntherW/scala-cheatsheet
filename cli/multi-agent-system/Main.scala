...
/** Einstiegspunkt: Führt das Multi-Agenten-System für ein Beispielthema aus
  * und schreibt die Zwischenergebnisse sowie den finalen Bericht in
  * Textdateien im Ordner `./output` (Dateizugriff über os-lib).
  *
  * Aufruf:
  * {{{
