...
/** Basisklasse für alle Agenten im Multi-Agenten-System.
  ...
  *     liefert nur den Aufrufwunsch zurück (`stop_reason == "tool_use"`), WIR führen die Funktion aus und senden das Ergebnis zurück (Multi-Turn-Loop, siehe `AnthropicClient.chatWithTool`).
