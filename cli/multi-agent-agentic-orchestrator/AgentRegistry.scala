...
/** Zentrale Registry aller verfügbaren Agenten. Einziger Ort, der angepasst werden muss, um einen neuen Agenten in das System einzubinden - weder `Orchestrator` (Execution) noch `AgentPlanner`
