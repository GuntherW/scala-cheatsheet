...
object DoobieDemo extends IOApp.Simple:
  ...
  val run =
    findMovieByTitle2("Zack Snyder's Justice League").debugPrint.as(ExitCode.Success)
//    findMovieByTitle("Zack Snyder's Justice League").debugPrint.as(ExitCode.Success)
//    findAllActorNamesCustomClass.debugPrint.as(ExitCode.Success)
//    findActorById(1).debugPrint.as(ExitCode.Success)
//    actorNamesStream.debugPrint.as(ExitCode.Success)
//    findActorsByInitial("H").debugPrint.as(ExitCode.Success)
//    saveActor(99, "Hotzenplotz").debugPrint.as(ExitCode.Success)
//    saveActor_v2(33, "Hermann").debugPrint.as(ExitCode.Success)
//    saveActorAutoGenerated("Tom").debugPrint.as(ExitCode.Success)
//  saveMultipleActors(List("Alice", "Bob", "Charlie")).debugPrint.as(ExitCode.Success)
